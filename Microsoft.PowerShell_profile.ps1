...
function nppp([string]$FilePath=$null){
	if($FilePath -eq $null){
...
Set-Alias -Name nano -Value nppp
Set-Alias -Name npp -Value nppp
Set-Alias -Name n++ -Value nppp
Set-Alias -Name notepad++ -Value nppp
Set-Alias -Name notepad -Value nppp
...
oh-my-posh init pwsh --config https://raw.githubusercontent.com/dcoffin88/powershell-profile/refs/heads/main/cobalt2.omp.json | Invoke-Expression
